...
class Common(CommonConfig):
    ...
    def coreset0_index(self):
        return self._coreset0_index.value

    @coreset0_index.setter
    def coreset0_index(self, value):
        self._coreset0_index.value = value

    @property
    def ss0_index(self):
        return self._ss0_index.value

    @ss0_index.setter
    def ss0_index(self, value):
        self._ss0_index.value = value

    @property
    def max_coreset0_duration(self):
        return self._max_coreset0_duration.value

    @max_coreset0_duration.setter
    def max_coreset0_duration(self, value):
        self._max_coreset0_duration.value = value

    @property
    def ss1_n_candidates(self):
        return self._ss1_n_candidates.value

    @ss1_n_candidates.setter
    def ss1_n_candidates(self, value):
        self._ss1_n_candidates.value = value

...
class Dedicated(CommonConfig):
    ...
    def coreset1_rb_start(self):
        return self._coreset1_rb_start.value

    @coreset1_rb_start.setter
    def coreset1_rb_start(self, value):
        self._coreset1_rb_start.value = value

    @property
    def coreset1_l_crb(self):
        return self._coreset1_l_crb.value

    @coreset1_l_crb.setter
    def coreset1_l_crb(self, value):
        self._coreset1_l_crb.value = value

    @property
    def coreset1_duration(self):
        return self._coreset1_duration.value

    @coreset1_duration.setter
    def coreset1_duration(self, value):
        self._coreset1_duration.value = value

    @property
    def dci_format_0_1_and_1_1(self):
        return self._dci_format_0_1_and_1_1.value

    @dci_format_0_1_and_1_1.setter
    def dci_format_0_1_and_1_1(self, value):
        self._dci_format_0_1_and_1_1.value = value

    @property
    def ss2_type(self):
        return self._ss2_type.value

    @ss2_type.setter
    def ss2_type(self, value):
        self._ss2_type.value = value

    @property
    def ss2_n_candidates(self):
        return self._ss2_n_candidates.value

    @ss2_n_candidates.setter
    def ss2_n_candidates(self, value):
        self._ss2_n_candidates.value = value
